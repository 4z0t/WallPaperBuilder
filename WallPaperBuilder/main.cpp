...
int main(int argc, char* argv[])
{
    ...
    Lua::RegisterFunction(L, "SetColor", Lua::CFunction<SetColor, Uint8, Uint8, Uint8, Uint8>::Function);
    Lua::RegisterFunction(L, "DrawRect", Lua::CFunction<DrawRect, float, float, float, float>::Function);
    Lua::RegisterFunction(L, "DrawLine", Lua::CFunction<DrawLine, float, float, float, float>::Function);
    Lua::RegisterFunction(L, "GetWindowWidth", Lua::CFunction<GetWallpaperWindowWidth>::Function);
    Lua::RegisterFunction(L, "GetWindowHeight", Lua::CFunction<GetWallpaperWindowHeight>::Function);
